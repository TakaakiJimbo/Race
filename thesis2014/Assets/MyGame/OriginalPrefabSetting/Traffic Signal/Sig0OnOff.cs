...
public class Sig0OnOff : MonoBehaviour {
...
//	protected GameObject[,] walker_OnlySignalParentColor = new GameObject[2, 2];    // blue, red
	...
	void Start ()
	{
		...
		SignalParentColor [0, 0]            = gameObject.transform.FindChild("signal_blue").gameObject;
		SignalParentColor [0, 1]            = gameObject.transform.FindChild("signal_yellow").gameObject;
