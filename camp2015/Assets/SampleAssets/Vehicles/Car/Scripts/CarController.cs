...
namespace UnitySampleAssets.Vehicles.Car
{
    public class CarController : MonoBehaviour
    {
		...
		[SerializeField] public  float maxSpeed = 60; // the maximum speed (in meters per second!)
        [SerializeField] public  float maxTorque = 35; // the maximum torque of the engine
        [SerializeField] public  float minTorque = 10; // the minimum torque of the engine
